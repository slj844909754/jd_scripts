...
function invite2() {
  ...
  var headers = {
    ...
    'referer': 'https://assignment.jd.com/?inviterId=JtSrV2ebPXsjgNL%2F4ET5ywaDqJyw27u8TJIVDz%2FncYI%3D=&lng=0.000000&lat=0.000000&sid=2131b85f0bcb82714e032402628cc2fw&un_area=12_904_50647_57886',
    'Cookie': cookie
  };

  var dataString = `functionId=TaskInviteService&body={"method":"participateInviteTask","data":{"channel":"1","encryptionInviterPin":"JtSrV2ebPXsjgNL%2F4ET5ywaDqJyw27u8TJIVDz%2FncYI%3D","type":1}}&appid=market-task-h5&uuid=&_t=${t}`;
...
function invite() {
  ...
  var dataString = `functionId=InviteFriendApiService&body={"method":"attendInviteActivity","data":{"inviterPin":"JtSrV2ebPXsjgNL%2F4ET5ywaDqJyw27u8TJIVDz%2FncYI%3D","channel":1,"token":"","frontendInitStatus":""}}&referer=-1&eid=eidIf3dd8121b7sdmiBLGdxRR46OlWyh62kFAZogTJFnYqqRkwgr63%2BdGmMlcv7EQJ5v0HBic81xHXzXLwKM6fh3i963zIa7Ym2v5ehnwo2B7uDN92Q0&aid=&client=ios&clientVersion=14.4&networkType=wifi&fp=-1&appid=market-task-h5&_t=${t}`;
